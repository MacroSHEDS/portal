nSiteNVar_tab <- tabPanel("Time Series",
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            conditionalPanel(
                '["Concentration", "VWC"].includes(input.CONC_FLUX3)',
                selectizeInput("CONC_UNIT3",
                    label = NULL, choices = conc_units,
                    selected = "mg/L"
                )
            ),
            conditionalPanel(
                'input.CONC_FLUX3 == "Flux"',
                selectizeInput("FLUX_UNIT3",
                    label = NULL, choices = flux_units,
                    selected = "kg/ha/d"
                )
            ),
            br(),
            ...
            conditionalPanel(
                "input.ADDTL_OPTIONS % 2 == 1",
                br(),
                div(
                    style = "display: none", # hiding this until we reactivate high res mode
                    div("Time system",
                        class = "widget-title text-center"
                    ),
                ...
                div(
                    ...
                    div(
                        ...
                        title = paste(
                            "Points flagged as erroneous (bad data)",
                ...
                div(
                    ...
                    div(
                        ...
                        style = "display: inline-block; vertical-align: middle",
                        title = paste(
                            "We linearly interpolate data gaps of up",
