        ...
        modalDialog(
            ...
            fluidRow(class = 'text-left',
                column(12,
                    ...
                    h3('Watershed time-series',
                       style = 'padding-bottom: 0px'),
                    div('Spatial summaries of gridded time-series data in long (indexed) format.',
                        class = 'widget-caption text-left'),
                    div('Choose categories:',
                        style = "padding-bottom: 6px; padding-top: 6px",
                        class = 'widget-title text-left'),
                    checkboxGroupInput(
                        inputId = 'DL_SETS_SPATIALTS',
                        label = NULL,
                        choiceNames = c('Climate (precip, temp, deposition, ET ref)',
                                        ...
                                        'Vegetation (NLCD landcover, phenology, metabolism, etc.)'),
                        choiceValues = c('climate', 'hydro', 'parentmat',
                                         'terrain', 'veg')
                    ),
                    br(),
