...
summary_biplot_tab = tabPanel('Biplot', value='biplot',
    sidebarLayout(
        ...
        selectizeInput('X_TYPE2', label=NULL,
                       multiple=FALSE, choices=biplot_data_types_x, selected = 'Stream Concentration'),
        ...
        selectizeInput('Y_VAR2', label = NULL,
                       selected = 'Q',
                       multiple = FALSE, choices = 'Q'),
        selectizeInput('Y_UNIT2', label = NULL,
                       multiple = FALSE, choices = discharge_units_bi, selected = discharge_units_bi[1]),
        ...
        radioButtons('ADD_SIZE2', label=NULL,
                     choices=c('Yes'='SIZE_YES2',
                               'No'='SIZE_NO2'),
                     selected='SIZE_NO2'),
        conditionalPanel('input.ADD_SIZE2 == "SIZE_YES2"',
